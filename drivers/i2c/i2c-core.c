...
#define GPIO_I2C_NFC_SDA       10
#define GPIO_I2C_NFC_SCL       11
#define GPIO_I2C_PRIM_SDA      14
#define GPIO_I2C_PRIM_SCL      15
#define GPIO_I2C_TP_SDA        18
#define GPIO_I2C_TP_SCL        19
#define GPIO_I2C_PMA_SDA       22
#define GPIO_I2C_PMA_SCL       23

#define MSM_8226_BLSP1_QUP2_I2C_BUS_ID   2
#define MSM_8226_BLSP1_QUP3_I2C_BUS_ID   3
#define MSM_8226_BLSP1_QUP4_I2C_BUS_ID   4
#define MSM_8226_BLSP1_QUP5_I2C_BUS_ID   5
#define MSM_8226_BLSP1_QUP6_I2C_BUS_ID   6
...
void i2c_reset_device(struct i2c_adapter *adap)
{
	...
	switch (adap->nr) {
	case MSM_8226_BLSP1_QUP2_I2C_BUS_ID:
		scl = GPIO_I2C_SECO_SCL;
		sda = GPIO_I2C_SECO_SDA;
		break;
	case MSM_8226_BLSP1_QUP3_I2C_BUS_ID:
		scl = GPIO_I2C_NFC_SCL;
		sda = GPIO_I2C_NFC_SDA;
		break;
	case MSM_8226_BLSP1_QUP4_I2C_BUS_ID:
		scl = GPIO_I2C_PRIM_SCL;
		sda = GPIO_I2C_PRIM_SDA;
		break;
	case MSM_8226_BLSP1_QUP5_I2C_BUS_ID:
		scl = GPIO_I2C_TP_SCL;
		sda = GPIO_I2C_TP_SDA;
		break;
	case MSM_8226_BLSP1_QUP6_I2C_BUS_ID:
		scl = GPIO_I2C_PMA_SCL;
		sda = GPIO_I2C_PMA_SDA;
		break;
	default:
