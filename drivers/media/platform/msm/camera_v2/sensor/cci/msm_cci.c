...
static int8_t g_cci_i2c_status = 0;

static int32_t msm_cci_clear_i2c_status( void )
{
    g_cci_i2c_status = 0;
    return 0;
}

static int32_t msm_cci_get_i2c_status( void )
{
    return g_cci_i2c_status;
}
#endif
	...
	struct msm_camera_cci_ctrl *cci_ctrl)
{
	...
	case MSM_CCI_GPIO_WRITE:
		break;
#ifdef FEATURE_KYOCERA_MCAM
  case MSM_CCI_CLEAR_I2C_STATUS:
    rc = msm_cci_clear_i2c_status();
    break;
  case MSM_CCI_GET_I2C_STATUS:
    rc = msm_cci_get_i2c_status();
    break;
#endif
